...
// 큐레이션 기준: 기분 톤에 맞춰 국내·해외 / 시대(90s~현재) / 장르를 고루 섞는다.
...
export const SONGS = {
  ...
  flutter: [
    ...
    s('Sugar', 'Maroon 5'),
    s('La Vie en Rose', 'Édith Piaf'),
    s('Best Part', 'Daniel Caesar, H.E.R.'),
  ],
  ...
  blue: [
    ...
    s('서른 즈음에', '김광석'),
    s('옛사랑', '이문세'),
    s('어떻게 이별까지 사랑하겠어, 널 사랑하는 거지', '악동뮤지션'),
    s('보고싶다', '김범수'),
    s('이별택시', '김연우'),
    s('Love poem', '아이유'),
