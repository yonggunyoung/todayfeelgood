...
const C = 'gwangclick-v6';
const ASSETS = ['./', './index.html', './toss.js', './fb-config.js', './net.js', './gc-util.js', './gc-cosmetics.js', './i18n.js', './geo.js', './topics.js', './gc-globe.js', './manifest.webmanifest', './icon.svg'];
