...
4) 분량은 1인분 기준으로 환산하세요.
5) tags는 다음 중에서만: 반찬, 고단백, 운동, 자취, 초간단, 국물, 집밥, 도시락, 다이어트, 순한맛, 매콤, 아침

마지막 응답은 설명 없이 JSON 하나만:
{"ok":true,"title":"요리명","time":15,"kcal":400,"protein":20,"tags":["국물"],"ingredients":[{"name":"두부","amount":0.5,"unit":"모","seasoning":false}],"steps":["..."]}
